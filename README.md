...
## OUTPUT:
## With memset()
<img width="1014" height="145" alt="With memset()" src="https://github.com/user-attachments/assets/d9da8148-84bd-44a9-987e-9d18a6da9782" />

## Without memset()
<img width="992" height="151" alt="Without memset()" src="https://github.com/user-attachments/assets/72b80533-e5b8-422b-abf5-f8f84a422f3b" />


## RESULT:
Thus the program has been executed by using unified memory. It is observed that removing memset function has given less/more 0.000329 sec time.
